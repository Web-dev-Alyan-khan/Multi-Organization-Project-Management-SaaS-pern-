            ...
            <div className="flex items-center justify-between max-w-6xl mx-auto">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center">
                        {/* Only shows if user is signed out */}
                        <SignedOut>
                            <SignInButton mode="modal">
                                <button className="px-4 py-1.5 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-all active:scale-95">
                                    Sign In
                                </button>
                            </SignInButton>
                        </SignedOut>
